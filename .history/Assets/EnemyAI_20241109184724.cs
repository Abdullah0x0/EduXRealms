...
{
    public float runSpeed = 0.4f; // Speed at which the enemy runs away
    ...
    void Update()
    {
        ...
        // Check if the player is looking at the enemy (within the detection angle)
        ...
        {
            // If the enemy is not running, play the idle animation
