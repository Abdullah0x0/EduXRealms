...
public class EnemyAI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Position the enemy 100 cm (1 meter) in front of the player
        if (playerTransform != null)
        {
            transform.position = playerTransform.position + playerTransform.forward * 1.0f; // 1 meter in front of the player
        }
        else
        {
